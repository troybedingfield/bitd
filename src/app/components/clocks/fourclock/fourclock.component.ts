...
@Component({
  selector: 'app-fourclock',
  imports: [NgxEchartsDirective, ButtonComponent, ReactiveFormsModule],
  templateUrl: './fourclock.component.html',
  styleUrl: './fourclock.component.scss',
  providers: [provideEchartsCore({ echarts })],
})
export class FourclockComponent implements OnInit {
    ...
    series: [
      {
        ...
        data: [
          { value: 90, itemStyle: { color: 'white' } },
          { value: 90, itemStyle: { color: 'white' } },
          { value: 90, itemStyle: { color: 'white' } },
          { value: 90, itemStyle: { color: 'white' } },
